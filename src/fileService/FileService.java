   ...
   static public HashMap<Integer, Hero> getIdHero() {
    ...
    public Hero write() {
       //Hero service
        ...
        info= new StringBuilder().append(id).append(",").append(hero1.getName()).append(",").append(hero1.getSex()).append(",").append(hero1.getRace()).append(",").append(hero1.getHeight()).append(",").append(type) + "\n";
        ...
        params= builder.append(id).append(",").append(hero1.getPlayerPositionX()).append(",").append(hero1.getPlayerPositionY()).append(",").append(hero1.getCoins()).append(",").append(hero1.getLevel()).append(",").append(hero1.getExperience()).append(",").append(hero1.getAbilityCastCount()).append(",").append(hero1.getHealth()).append(",").append(hero1.getBaseDamage()).append(",").append(hero1.getDefence()).toString();
